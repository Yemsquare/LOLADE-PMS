...
?>
        ...
        <div class="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                            <div class="card-header">                                
                                <h4 class="m-b-0 ">New Invoice <span class="pull-right"><?php date_default_timezone_set("AFRICA/Lagos"); echo date("l jS \of F Y h:i:s A") ?></span></h4>
                            </div>
                            <div class="card-body">
            ...
            <footer class="footer"> © 2020 Lolade PMS</footer>
