        ...
        <div class="login-box card">
            <div class="card-body loginpage">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="login/signIn">
                   ...
                   <img src="<?php echo base_url(); ?>assets/images/home_logo1.png" alt="Home" height="100" /></a>
                    ...
                    <div class="form-group text-center m-t-40">
                        <div class="col-xs-12">
                            <a href="<?php echo base_url() ?>Counter" class="btn btn-info btn-md btn-login btn-block text-uppercase waves-effect waves-light">Counter</a>
                        </div>
                    </div>            
        </div>
    </section>
